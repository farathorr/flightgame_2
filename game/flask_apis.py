    ...
    try:
        ...
        response_json = json.dumps(
            {"id": game.id, "money": game.money, "co2_budget": game.co2_budget,
             ...
             "current_icao": game.location.icao, "current_airportname": game.location.name, "turn": game.turn, "current_co2lvl": game.plane.co2level, "current_passengerlvl": game.plane.psngrlvl})
        print(response_json)
